...
import CustomerListPage from 'pages/management/customer/list';
import HolidaySurcharge from 'pages/management/price/holidaySurcharge/list';
import Pricing from 'pages/management/price/pricing/list';
import ManagerManagement from 'pages/management/manager/list';
import VoucherManagement from 'pages/management/voucher/list';
import WithdrawManagement from 'pages/management/withdraw/list';
import CustomerManagement from 'pages/management/customer-management/list';
import PaymentList from 'pages/management/payment/list';
import BonusManagement from 'pages/management/bonus/list';
import InsurancePolicyManagement from 'pages/management/insurance/insurancePolicy/list';
import BookingTypeManagement from 'pages/management/insurance/bookingType/list';
import InsuranceClaimManagement from 'pages/management/insurance/insuranceClaim/list';
...
// render - management
const DriverManagement = Loadable(lazy(() => import('pages/management/driver/list')));
const ScheduleManagement = Loadable(lazy(() => import('pages/management/schedule/list')));
const TripBookingManagement = Loadable(lazy(() => import('pages/management/trip-booking/list')));
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: 'booking-type',
                  element: <BookingTypeManagement />
                },
                {
                  path: 'insurance-claim',
                  element: <InsuranceClaimManagement />
                }
              ]
            },
            {
              ...
              children: [
                {
                  path: 'holiday-surcharge',
                  element: <HolidaySurcharge />
                },
                {
                  path: 'pricing',
                  element: <Pricing />
