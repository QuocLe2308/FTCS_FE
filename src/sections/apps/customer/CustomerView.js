          ...
          <Grid container spacing={2.5} sx={{ pl: { xs: 0, sm: 5, md: 6, lg: 10, xl: 12 } }}>
            ...
            <Grid item xs={12} sm={7} md={8} lg={8} xl={9}>
              <Stack spacing={2.5}>
                  ...
                  <List sx={{ py: 0 }}>
                    <ListItem divider={!matchDownMD}>
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                          <Stack spacing={0.5}>
                            <Typography color="secondary">Tên cha</Typography>
                            <Typography>
                              Ông {data.firstName} {data.lastName}
                            </Typography>
                          </Stack>
                        </Grid>
                      </Grid>
                    ...
                    <ListItem divider={!matchDownMD}>
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} md={6}>
                          <Stack spacing={0.5}>
                            <Typography color="secondary">Mã bưu điện</Typography>
                            <Typography>
                ...
                <MainCard title="Về tôi">
                  <Typography color="secondary">
                    Xin chào, tôi là {data.name} {data.role} làm việc tại công ty quốc tế, {data.about}
                  </Typography>
                </MainCard>
              </Stack>
            </Grid>
