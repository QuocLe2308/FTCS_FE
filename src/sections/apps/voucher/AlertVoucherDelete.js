...
export default function AlertVoucherDelete({ voucherDeleteId, open, handleClose, refetch }) {
  const deletehandler = async () => {
    await deleteVoucher(voucherDeleteId).then(() => {
      openSnackbar({
        open: true,
