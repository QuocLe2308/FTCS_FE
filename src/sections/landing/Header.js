          ...
          <Grid container spacing={2} sx={{ pr: 10, [theme.breakpoints.down('md')]: { pr: 0, textAlign: 'center' } }}>
            <Grid item xs={12}>
              ...
              >
                ...
                >
                  <span>Hệ Thống Kết Nối Vận Chuyển Hàng Hóa </span>
            ...
            <Grid item xs={12}>
              ...
              >
                ...
                >
                  Hệ thống kết nối vận chuyển hàng hóa (FTCS) là nền tảng trực tuyến kết nối tài xế với khách hàng cần vận chuyển hàng hóa
                  ...
                  <Grid item>
                    <AnimateButton>
                      <Button
                        ...
                        color="primary"
                        variant="contained"
                        startIcon={<RightCircleOutlined style={{ fontSize: '1.15rem' }} />}
                        sx={{
                          borderRadius: 2,
                          px: 4,
                          py: 1.5,
